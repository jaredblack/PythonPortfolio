# -*- coding: utf-8 -*-
"""Intro_to_Python_II - jblack46.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1L0EJ1f_N2utaOldYQXbLBIP2VSGnyoj-
...
my_vect_var = (np.dot(v, u) / np.dot(u, u)) * u + (np.dot(v, w) / np.dot(w, w) * w)
  # Replace the value of 0 with the required value from Problem 5.
...
long_list= [np.power(0.5, i) for i in range(1, 101)]
