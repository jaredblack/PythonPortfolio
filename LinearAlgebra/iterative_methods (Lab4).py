# -*- coding: utf-8 -*-
"""Iterative_methods.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/149lDgKnw-o1dL-mmZwZgbgn7ivZf9tuh
...
def gs1_error(n): 
    ...
    return np.linalg.norm(np.array([1, 1]) - np.array(gs1_method(n)))
...
def gs2_error(n): 
    return np.linalg.norm(np.array([2, 1]) - np.array(gs2_method(n)))
